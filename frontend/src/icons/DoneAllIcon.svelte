...
<svg style="width: 100%; margin: 0% auto; stroke: {strokeColor}" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <title>{title}</title>
  <path d="M8.00011 13L12.2278 16.3821C12.6557 16.7245 13.2794 16.6586 13.6264 16.2345L22.0001 6" stroke-width="2" stroke-linecap="round"/>
